...
#
#
#     xt[:, :, :, 0:n_win//4, 0:n_win//4, :] = x0  # B n/3 n/3 d2c
#     xt[:, :, :, 0:n_win//4, n_win//4:2*(n_win//4), :] = x1  # B n/3 n/3 d2c
#     xt[:, :, :, 0:n_win//4, 2*(n_win//4):3*(n_win//4), :] = x2  # B n/3 n/3 d2c
#     xt[:, :, :, 0:n_win//4, 3*(n_win//4):n_win, :] = x3  # B n/3 n/3 d2c
#     xt[:, :, :, n_win//4:2*(n_win//4), 0:n_win//4, :] = x4  # B n/3 n/3 d2c
#     xt[:, :, :, n_win//4:2*(n_win//4), n_win//4:2 * (n_win//4), :] = x5  # B n/3 n/3 d2c
#     xt[:, :, :, n_win//4:2*(n_win//4), 2*(n_win//4):3*(n_win//4), :] = x6  # B n/3 n/3 d2c
#     xt[:, :, :, n_win//4:2*(n_win//4), 3*(n_win//4):n_win, :] = x7  # B n/3 n/3 d2c
#     xt[:, :, :, 2*(n_win//4):3*(n_win//4), 0:n_win//4, :] = x8  # B n/3 n/3 d2c
#     xt[:, :, :, 2*(n_win//4):3*(n_win//4), n_win//4:2*(n_win//4), :] = x9  # B n/3 n/3 d2c
#     xt[:, :, :, 2*(n_win//4):3*(n_win//4), 2*(n_win//4):3*(n_win//4), :] = x10  # B n/3 n/3 d2c
#     xt[:, :, :, 2*(n_win//4):3*(n_win//4), 3*(n_win//4):n_win, :] = x11  # B n/3 n/3 d2c
#     xt[:, :, :, 3*(n_win//4):n_win, 0:n_win//4, :] = x12  # B n/3 n/3 d2c
#     xt[:, :, :, 3*(n_win//4):n_win, n_win//4:2*(n_win//4), :] = x13 # B n/3 n/3 d2c
#     xt[:, :, :, 3*(n_win//4):n_win, 2*(n_win//4):3*(n_win//4), :] = x14  # B n/3 n/3 d2c
#     xt[:, :, :, 3*(n_win//4):n_win, 3*(n_win//4):n_win, :] = x15  # B n/3 n/3 d2c
#     xt = xt.permute(0, 1, 3, 2, 4, 5)
#     xt = xt.reshape(-1, H, W, C)
#
#     return xt
...
def Win_ReDila02(x, win_size):
    ...
    xt = torch.zeros_like(x)
    xt[:, :, :, 0::4, 0::4, :] = x[:, :, :, 0:n_win // 4, 0:n_win // 4, :]
    xt[:, :, :, 0::4, 1::4, :] = x[:, :, :, 0:n_win // 4, n_win // 4:2 * (n_win // 4), :]
    xt[:, :, :, 0::4, 2::4, :] = x[:, :, :, 0:n_win // 4, 2 * (n_win // 4):3 * (n_win // 4), :]
    xt[:, :, :, 0::4, 3::4, :] = x[:, :, :, 0:n_win // 4, 3 * (n_win // 4):n_win, :]
    xt[:, :, :, 1::4, 0::4, :] = x[:, :, :, n_win // 4:2 * (n_win // 4), 0:n_win // 4, :]
    xt[:, :, :, 1::4, 1::4, :] = x[:, :, :, n_win // 4:2 * (n_win // 4), n_win // 4:2 * (n_win // 4), :]
    xt[:, :, :, 1::4, 2::4, :] = x[:, :, :, n_win // 4:2 * (n_win // 4), 2 * (n_win // 4):3 * (n_win // 4), :]
    xt[:, :, :, 1::4, 3::4, :] = x[:, :, :, n_win // 4:2 * (n_win // 4), 3 * (n_win // 4):n_win, :]
    xt[:, :, :, 2::4, 0::4, :] = x[:, :, :, 2 * (n_win // 4) : 3 * (n_win // 4), 0:n_win // 4, :]
    xt[:, :, :, 2::4, 1::4, :] = x[:, :, :, 2 * (n_win // 4) : 3 * (n_win // 4), n_win // 4:2 * (n_win // 4), :]
    xt[:, :, :, 2::4, 2::4, :] = x[:, :, :, 2 * (n_win // 4) : 3 * (n_win // 4), 2 * (n_win // 4):3 * (n_win // 4), :]
    xt[:, :, :, 2::4, 3::4, :] = x[:, :, :, 2 * (n_win // 4) : 3 * (n_win // 4), 3 * (n_win // 4):n_win, :]
    xt[:, :, :, 3::4, 0::4, :] = x[:, :, :, 3 * (n_win // 4):n_win, 0:n_win // 4, :]
    xt[:, :, :, 3::4, 1::4, :] = x[:, :, :, 3 * (n_win // 4):n_win, n_win // 4:2 * (n_win // 4), :]
    xt[:, :, :, 3::4, 2::4, :] = x[:, :, :, 3 * (n_win // 4):n_win, 2 * (n_win // 4):3 * (n_win // 4), :]
    xt[:, :, :, 3::4, 3::4, :] = x[:, :, :, 3 * (n_win // 4):n_win, 3 * (n_win // 4):n_win, :]
...
class Stage(nn.Module):
    def __init__(self, dim=32, input_resolution=(16, 16), num_heads=8, window_size=4,
        ...
        self.X_D = nn.Linear(dim, dim*2,True)
    ...
    def forward(self, x):
        ...
        x = self.norm3(x)
        x_d = self.X_D(x)
        x1, x2 = x_d.chunk(2,dim = 2)
        x1 = self.norm3(x1)
        x2 = self.norm3(x2)
        x1 = x1.view(B, H, W, C)
        x2 = x2.view(B, H, W, C)

        shifted_x1 = Win_Dila(x1, self.window_size)
        ...
        attn_windows1 = self.attn2(x_windows1)  # nW*B, window_size*window_size, C
        shifted_x1 = window_reverse(attn_windows1, self.window_size, H, W)  # B H' W' C
        x1 = Win_ReDila(shifted_x1, self.window_size)
        x1 = x1.view(B, H * W, C)

        shifted_x2 = Win_Dila(x2, self.window_size)
        ...
        attn_windows2 = self.attn2(x_windows2)  # nW*B, window_size*window_size, C
        shifted_x2 = window_reverse(attn_windows2, self.window_size, H, W)  # B H' W' C
        x2 = Win_ReDila(shifted_x2, self.window_size)
        x2 = x2.view(B, H * W, C)

        x = self.norm4(self.norm4(x1) + self.norm4(x2))
        x = shortcut + self.drop_path(x)
